...
def main():
    ...
    savings_interest = print(float(input("What is the interest rate in %")))
    savings_maturity =  print(float(input("How long to maturity?")))

    # Call the create_savings_account function and pass the variables from the user.
    updated_savings_balance, interest_earned = create_savings_account(savings_balance, 
                                                                      savings_interest, 
                                                                      savings_maturity)
    ...
    print("You earned $", format(savings.get_balance(), ",.2f, in interest"))
    ...
    updated_cd_balance, interest_earned = create_cd_account(cd_balance, cd_interest, 
                                                            cd_maturity)
    ...
    print("Your account balance is $", format(savings.get_balance(), ",.2f"))
    print("You earned $", format(savings.get_balance(), ",.2f, in interest"))
    print("Your updated CD balance is $", format(????), ",".f)
